- ### data
    ...
    - #Design 以下為MVC實際在伺服器和客戶端之間的實現方式，在這裡伺服器會根據客戶端發送的請求來提供網頁畫面給客戶端，請解釋圖中的每個步驟是如何 ![](https://res.cloudinary.com/dqfxgtyoi/image/upload/v1633596645/blog/network/ClientAndServer/MVCModel_dgvnhm.png)
        - [[December 21st, 2023]] 🔵
            - nextDueDate:: [[December 27th, 2023]]
            - eFactor:: 2.5
            - interval:: 6
            - repetitions:: 2
            - grade:: 4
    ...
    - #Test Cross-Site Request Forgery 的Cross-會是甚麼意思?
        - [[December 1st, 2023]] 🔵
            ...
            - repetitions:: 1
            - grade:: 4
    - #Test Cross-Site Request Forgery的Request Forgery 是甚麼意思?
        - [[December 1st, 2023]] 🔵
            - nextDueDate:: [[December 2nd, 2023]]
            - eFactor:: 2.5
            - interval:: 1
    ...
    - #Test redirect_uri 是用來接收token的地點： implicit grant type 在OAuth上的流程為何？ 
        ...
        - [[November 25th, 2023]] 🔵
            ...
            - grade:: 4
        - [[November 16th, 2023]] 🔵
            - nextDueDate:: [[November 17th, 2023]]
            - eFactor:: 2.5
            - interval:: 1
            - repetitions:: 1
            - grade:: 4
    ...
    - #Test OAuth 存在著 "token 的使用者(client)是否為合法對象(client)" 這個問題，那麼解法概念為何?
        - [[November 25th, 2023]] 🔵
            ...
            - grade:: 4
        - [[November 14th, 2023]] 🔵
            - nextDueDate:: [[November 20th, 2023]]
            - eFactor:: 2.5
            - interval:: 6
            - repetitions:: 2
            - grade:: 4
    ...
    - #Test authorization code grant type 在OAuth 上的授權流程中：authorization code 使用限制是有效時間通常很短，如10分鐘、用碼申請token的次數是有限的，如1次，若違反限制的話，會如何？
        - [[November 25th, 2023]] 🔵
            - nextDueDate:: [[December 19th, 2023]]
            - eFactor:: 2.5
            - interval:: 24
            - repetitions:: 4
            - grade:: 4
    ...
    - #Test authorization code grant type 在OAuth 上的授權流程中："使用者訪問身為客戶端的應用服務A，應用服務A將使用者導向網路服務提供商之認證授權伺服器來認證使用者、詢問授權範疇、是否授權"，這步驟所需要的必填參數會是什麼？ 
        - [[November 25th, 2023]] 🔵
            - nextDueDate:: [[December 12th, 2023]]
            - eFactor:: 2.1799999999999997
            - interval:: 17
            - repetitions:: 4
            - grade:: 4
        - [[November 14th, 2023]] 🔵
            - nextDueDate:: [[November 24th, 2023]]
            - eFactor:: 2.1799999999999997
            - interval:: 10
            - repetitions:: 3
            - grade:: 4
    ...
    - #Test 在Open Authorization 或者OAuth的Client-Server中，Resource Server和Authorization Server 之間差別是什麼？ 
        ...
        - [[October 25th, 2023]] 🔵
            ...
            - repetitions:: 1
            - grade:: 4
    - #Test 在Open Authorization 或者OAuth的Client-Server中，Resource Server vs  Authorization Server 兩者在實現上是否能在同一台主機擔任兩個角色？ 
        - [[November 15th, 2023]] 🔵
            - nextDueDate:: [[December 9th, 2023]]
            - eFactor:: 2.5
            - interval:: 24
    ...
    - #Test 在Open Authorization 或者OAuth的Client-Server中，若Resource Server會管理資源和驗證Token，那麼Resource Server會有什麼樣的業務
        - [[November 16th, 2023]] 🔵
            - nextDueDate:: [[December 10th, 2023]]
            - eFactor:: 2.5
            - interval:: 24
            - repetitions:: 4
            - grade:: 4
    ...
    - #Test REST是一種 以資源為中心，用HTTP方法操作資源，並且最終目標為打造出滿足於HATEOAS之產品的網路軟體開發風格，請問何謂最終目標？說明清楚那HATEOAS之產品 
        - [[November 25th, 2023]] 🔵
            ...
            - grade:: 4
        - [[November 16th, 2023]] 🔵
            - nextDueDate:: [[November 22nd, 2023]]
            - eFactor:: 1.5399999999999996
            - interval:: 6
            - repetitions:: 2
            - grade:: 4
